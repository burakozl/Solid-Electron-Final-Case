...
export class FilterProductPipe implements PipeTransform {
  ...
  transform(value: Product[], searchedWord:string) {
    ...
    return value.filter((product) => product.name.toLocaleLowerCase().includes(searchedWord.toLowerCase()));
    //girilen input değeri product name içersinde varsa return et...
